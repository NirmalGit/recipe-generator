    ...
    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-orange-100 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 text-center">
        <div className="bg-orange-50 p-4 rounded-lg">
            <p className="font-bold text-orange-800">Prep Time</p>
            <p className="text-gray-700">{recipe.prepTime}</p>
        </div>
        <div className="bg-green-50 p-4 rounded-lg">
            <p className="font-bold text-green-800">Servings</p>
            <p className="text-gray-700">{recipe.servings}</p>
        </div>
        <div className="bg-yellow-50 p-4 rounded-lg">
            <p className="font-bold text-yellow-800">Ingredients</p>
            <p className="text-gray-700">{recipe.ingredients.length} items</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        <div className="lg:col-span-2">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-orange-200 pb-2">Ingredients</h3>
        ...
        <div className="lg:col-span-3">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4 border-b-2 border-green-200 pb-2">Instructions</h3>
